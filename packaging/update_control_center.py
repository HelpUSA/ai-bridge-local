...
cmd = [
    ...
    '--name', NAME,
    '--runtime-hook', 'packaging/pyinstaller_runtime_hook.py',
    '--hidden-import', '_kinter',
    '--add-data', str(tkpkg) + ';py_lib/tkinter',
    '--add-data', str(tcl) + ';_tcl_data',
    '--add-data', str(tk) + ';_tk_data',
    '--add-data', str(tcl) + ';tcl',
    '--add-data', str(tk) + ';tk',
