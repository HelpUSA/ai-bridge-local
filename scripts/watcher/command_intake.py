...
def build_plan(intent, cwd, command_id, timeout, dry_run, allow_git_write, allow_network_push, release_check_ok, inline_command):
...
def main():
 ...
 plan = build_plan(args.intent, args.cwd, args.command_id, args.timeout, args.dry_run, args.allow_git_write, args.allow_network_push, args.release_check_ok, args.inline_command)
 if args.execute:
